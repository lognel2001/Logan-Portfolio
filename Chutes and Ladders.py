...
##  File "C:\Users\logan.h.nelson\OneDrive - tooelesd\examples folder\Chutes and Ladders.py", line 250, in <module>
##    main()
##  File "C:\Users\logan.h.nelson\OneDrive - tooelesd\examples folder\Chutes and Ladders.py", line 210, in main
##    players[turn].move()
##  File "C:\Users\logan.h.nelson\OneDrive - tooelesd\examples folder\Chutes and Ladders.py", line 53, in move
...
class Player(object):
    ...
    def move(self):
        ...
        if self.position + roll <= 99:
            ...
            ## you forgot the equal sign right here making it so that the -1 sets it equal to the endo of the list
       ...
       try: 
           ...
           if num in range(low,high):
               return num
                ...
                print("\nMust be a number between 2-4 players.")
       except:
...
def switch_turn(num_players,turn):
    ...
    return turn
def winner_grats():
    print("The player who won the game is")
